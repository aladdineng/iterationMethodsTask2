...
******************************************************************/
const incometransaction = transactions.filter((transaction) => {
...
const expensetransaction = transactions.filter((transaction) => {
...
const calculateincome = transactions.forEach((transaction) => {
  if (transaction[0] == "income") {
...
let totalexpense = 0;
const calculateexpense = transactions.forEach((transaction) => {
  if (transaction[0] == "expense") {
    totalexpense = totalexpense + transaction[1];
  }
});
...
const aboveincome = transactions.filter((transaction) => {
  return transaction[1] > 500;
});
console.log(aboveincome);
